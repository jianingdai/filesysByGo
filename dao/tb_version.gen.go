...
func newVersion(db *gorm.DB, opts ...gen.DOOption) version {
	...
	_version.versionDo.UseModel(&models.Version{})
...
type IVersionDo interface {
	...
	Unscoped() IVersionDo
	Create(values ...*models.Version) error
	CreateInBatches(values []*models.Version, batchSize int) error
	Save(values ...*models.Version) error
	First() (*models.Version, error)
	Take() (*models.Version, error)
	Last() (*models.Version, error)
	Find() ([]*models.Version, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Version, err error)
	FindInBatches(result *[]*models.Version, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Version) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Version, error)
	FirstOrCreate() (*models.Version, error)
	FindByPage(offset int, limit int) (result []*models.Version, count int64, err error)
...
func (v versionDo) Create(values ...*models.Version) error {
	if len(values) == 0 {
		return nil
	}
...
func (v versionDo) CreateInBatches(values []*models.Version, batchSize int) error {
	return v.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (v versionDo) Save(values ...*models.Version) error {
	if len(values) == 0 {
		return nil
	}
...
func (v versionDo) First() (*models.Version, error) {
	if result, err := v.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Version), nil
	}
}

func (v versionDo) Take() (*models.Version, error) {
...
func (v versionDo) Last() (*models.Version, error) {
...
func (v versionDo) Find() ([]*models.Version, error) {
	result, err := v.DO.Find()
	return result.([]*models.Version), err
}

func (v versionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Version, err error) {
	buf := make([]*models.Version, 0, batchSize)
...
func (v versionDo) FindInBatches(result *[]*models.Version, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (v versionDo) FirstOrInit() (*models.Version, error) {
...
func (v versionDo) FirstOrCreate() (*models.Version, error) {
...
func (v versionDo) FindByPage(offset int, limit int) (result []*models.Version, count int64, err error) {
...
func (v versionDo) Delete(models ...*models.Version) (result gen.ResultInfo, err error) {
