...
func newStoreRef(db *gorm.DB, opts ...gen.DOOption) storeRef {
	...
	_storeRef.storeRefDo.UseModel(&models.StoreRef{})
...
type IStoreRefDo interface {
	...
	Create(values ...*models.StoreRef) error
	CreateInBatches(values []*models.StoreRef, batchSize int) error
	Save(values ...*models.StoreRef) error
	First() (*models.StoreRef, error)
	Take() (*models.StoreRef, error)
	Last() (*models.StoreRef, error)
	Find() ([]*models.StoreRef, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.StoreRef, err error)
	FindInBatches(result *[]*models.StoreRef, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.StoreRef) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.StoreRef, error)
	FirstOrCreate() (*models.StoreRef, error)
	FindByPage(offset int, limit int) (result []*models.StoreRef, count int64, err error)
...
func (s storeRefDo) Create(values ...*models.StoreRef) error {
	if len(values) == 0 {
		return nil
	}
...
func (s storeRefDo) CreateInBatches(values []*models.StoreRef, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s storeRefDo) Save(values ...*models.StoreRef) error {
	if len(values) == 0 {
		return nil
	}
...
func (s storeRefDo) First() (*models.StoreRef, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.StoreRef), nil
	}
}

func (s storeRefDo) Take() (*models.StoreRef, error) {
...
func (s storeRefDo) Last() (*models.StoreRef, error) {
...
func (s storeRefDo) Find() ([]*models.StoreRef, error) {
	result, err := s.DO.Find()
	return result.([]*models.StoreRef), err
}

func (s storeRefDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.StoreRef, err error) {
	buf := make([]*models.StoreRef, 0, batchSize)
...
func (s storeRefDo) FindInBatches(result *[]*models.StoreRef, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s storeRefDo) FirstOrInit() (*models.StoreRef, error) {
...
func (s storeRefDo) FirstOrCreate() (*models.StoreRef, error) {
...
func (s storeRefDo) FindByPage(offset int, limit int) (result []*models.StoreRef, count int64, err error) {
...
func (s storeRefDo) Delete(models ...*models.StoreRef) (result gen.ResultInfo, err error) {
